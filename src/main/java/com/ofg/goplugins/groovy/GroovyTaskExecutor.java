...
public class GroovyTaskExecutor implements TaskExecutor {
    ...
    private ExecutionResult runCommand(final TaskExecutionContext taskContext,
                                       TaskConfig taskConfig) throws IOException, InterruptedException,
            URISyntaxException, ScriptException {
